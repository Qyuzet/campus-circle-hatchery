  ...
  const renderModal = () => {
    if (view === "translate") {
      return (
        <div
          ref={modalRef}
          className="absolute bg-white rounded-lg shadow-2xl border border-gray-200 w-64 z-[100]"
            ...
            <div className="border-t border-gray-100 pt-1.5 space-y-0.5">
              {[
                ...
                <button
                  key={lang}
                  onClick={() =>
                    handleAIAction("translate", { language: lang })
                  }
                  disabled={isProcessing}
    ...
    if (view === "custom") {
      return (
        <div
          ref={modalRef}
          className="absolute bg-white rounded-lg shadow-2xl border border-gray-200 w-96 z-[100]"
          style={{ top: `${position.top}px`, left: `${position.left}px` }}
        >
          <div className="p-2">
            <button
