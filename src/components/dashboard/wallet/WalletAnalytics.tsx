...
export function WalletAnalytics({
  ...
  const salesByCategory = ["Study Material", "Food", "Event"].map(
    (category) => {
      const categoryType =
        category === "Study Material" ? "marketplace" : category.toLowerCase();
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {salesByCategory.map(({ category, count, percentage }) => (
                <div key={category}>
